...
namespace THREE.Materials
{
	...
	public class Material : Element, IMaterial, IEquatable<Material>
	{
		...
		/// </summary>
		public List<object> ClippingPlanes { get; set; } // TODO: implement plane type support
		...
		/// </summary>
		public int Blending { get; set; } // TODO: add enum
		...
		/// </summary>
		public int Side { get; set; } // TODO: add enum
